...
export const LEVELS: LevelDefinition[] = [
  ...
  // Level 5: Dipole gate
  {
    ...
    learningObjective: "Dipoles create complex field patterns from superposition.",
    launchPoint: { x: 3, y: 10 },
    target: { x: 27, y: 10, radius: 1.5 },
    maxShots: 5,
    sources: [
  ...
  // Level 9: Line charge (charge distribution)
  {
    ...
    learningObjective: "Charge distributions create smoother, more complex field patterns.",
    launchPoint: { x: 3, y: 10 },
